...
public class DuiHuaDialog  extends Dialog{
    ...
    public DuiHuaDialog(Context context,String title,String content,String zuo,String quren,
			SelectDialogButtonListener Listener) {
	...
	public DuiHuaDialog(Context context, int theme) {
		super(context, R.style.HintDialogStyle);
		this.context=context;
	}
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		View huihuadialog=getLayoutInflater().inflate(R.layout.dialog_dianming, null);
